...
import (
    ...
    `github.com/liujiyong7/smaug/loader/internal/rt`
...
func TestLoad(t *testing.T) {
    ...
    rets := Load(bc, []Func{fn}, "dummy_module", []string{"github.com/liujiyong7/smaug/dummy.go"})
    ...
    require.Equal(t, "github.com/liujiyong7/smaug/dummy.go", file)
